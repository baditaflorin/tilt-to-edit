...
`,j=X(),N=new WeakMap,W=new Set;function L(e,t,n){return Math.min(n,Math.max(t,e))}function ot(e,t){return t===0?0:L(e,0,t-1)}function ct(e){return e==="sensor"||e==="stepper"||e==="slider"||e==="menu"?e:null}function dt(e){const t=e==null?void 0:e.split("|").map(n=>n.trim()).filter(Boolean);return t&&t.length>0?t:rt}function O(e,t){if(!e)return t;const n=Number(e);return Number.isFinite(n)?n:t}function R(e){switch(e){case"needs-permission":return"needs permission";default:return e}}function o(e,t,n){const i=document.createElement(e);return t&&(i.className=t),n!==void 0&&(i.textContent=n),i}function f(e){const t=o("div","tte-metric"),n=o("span","tte-metric-label",e),i=o("strong","tte-metric-value");return t.append(n,i),{root:t,value:i}}function T(e,t="default"){const n=o("button","tte-button",e);return n.type="button",t==="primary"&&(n.dataset.variant="primary"),n}function ut(e,t){e.replaceChildren();const n=document.createElement("style");n.textContent=at;const i=o("article","tte-shell"),r=o("header","tte-head"),s=o("div"),a=o("p","tte-kicker",t.kind==="sensor"?"Script Tag Sensor":t.kind==="menu"?"Hybrid Menu":t.kind==="slider"?"Continuous Control":"Discrete Control"),c=o("h2","tte-title",t.title),u=o("p","tte-copy",t.description),p=o("strong","tte-status","paused");s.append(a,c,u),r.append(s,p);const x=o("div","tte-metrics"),l=o("div","tte-stage"),m=o("div","tte-actions"),y=o("div","tte-actions"),v=o("ul","tte-diagnostics"),h=T("Enable tilt","primary"),E=T("Calibrate"),q=T("Pause");return m.append(h,E,q),i.append(r,x,l,m,y,v),e.append(n,i),{shell:i,status:p,stage:l,diagnostics:v,primaryActions:m,secondaryActions:y,requestPermissionButton:h,calibrateButton:E,pauseButton:q,metrics:x}}function lt(e){if(typeof e!="string")return e;const t=document.querySelector(e);if(!t)throw new Error(`Unable to find tilt embed target: ${e}`);return t}function pt(e,t={}){const n=ct(e.dataset.tiltToEdit??e.dataset.tiltType),i=t.kind??n??"sensor",r={sensor:{title:"Tilt Sensor",description:"This widget exposes live tilt intent so the host page can react with any motion-driven experience."},stepper:{title:"Tilt Stepper",description:"Lean left and right to nudge a draft value, then confirm explicitly."},slider:{title:"Tilt Slider",description:"Use tilt as a soft analog input, then confirm when the preview lands where you want it."},menu:{title:"Tilt Menu",description:"Tilt up and down to browse. Lean right to commit. Lean left to restore the current selection."}}[i],s=t.items??dt(e.dataset.tiltItems),a=t.min??O(e.dataset.tiltMin,0),c=t.max??O(e.dataset.tiltMax,100),u=t.value??O(e.dataset.tiltValue,42),p=ot(t.selectedIndex??O(e.dataset.tiltSelectedIndex,0),s.length);return{kind:i,title:t.title??e.dataset.tiltTitle??r.title,description:t.description??e.dataset.tiltDescription??r.description,items:s,selectedIndex:p,min:a,max:c,value:L(u,a,c),step:Math.max(t.step??O(e.dataset.tiltStep,1),1),sensitivity:Math.max(t.sensitivity??O(e.dataset.tiltSensitivity,20),1),stepThreshold:Math.max(t.stepThreshold??O(e.dataset.tiltStepThreshold,i==="menu"?8:6),1),backend:t.backend,autoStart:t.autoStart??!0,onState:t.onState,onChange:t.onChange,onCommit:t.onCommit}}function mt(e){switch(e.kind){case"slider":return{backend:e.backend??j,axisMode:"horizontal",smoothing:.75};case"stepper":return{backend:e.backend??j,axisMode:"horizontal",smoothing:.75,stepThreshold:e.stepThreshold};case"menu":return{backend:e.backend??j,axisMode:"both",smoothing:.72,stepThreshold:e.stepThreshold};default:return{backend:e.backend??j,axisMode:"both",deadZone:2,smoothing:.72,continuousRange:20}}}function D(e,t,n,i){i==null||i(n),e.dispatchEvent(new CustomEvent(`tilt-to-edit:${t}`,{detail:n,bubbles:!0,composed:!0}))}function H(e,t){e.status.textContent=R(t.status),e.status.dataset.state=t.status,e.requestPermissionButton.hidden=t.status!=="needs-permission",e.pauseButton.textContent=t.status==="active"?"Pause":"Resume",e.pauseButton.disabled=t.status==="blocked"||t.status==="unsupported"||t.status==="error",e.diagnostics.replaceChildren();for(const n of t.diagnostics){const i=o("li",void 0,n.message);e.diagnostics.append(i)}}function ht(e,t,n,i){const r=f("Status"),s=f("Intent X"),a=f("Intent Y"),c=f("Confirmations");n.metrics.append(r.root,s.root,a.root,c.root);const u=o("div","tte-vector-pad"),p=o("div","tte-vector-grid"),x=o("div","tte-vector-axis tte-vector-axis-x"),l=o("div","tte-vector-axis tte-vector-axis-y"),m=o("div","tte-vector-orb"),y=o("span","tte-vector-label tte-vector-label-x","X axis"),v=o("span","tte-vector-label tte-vector-label-y","Y axis");return u.append(p,x,l,m,y,v),n.stage.append(u),{update(h){H(n,h),r.value.textContent=R(h.status),s.value.textContent=h.intentVector.x.toFixed(2),a.value.textContent=h.intentVector.y.toFixed(2),c.value.textContent=String(h.confirmationSequence),m.style.transform=`translate(${h.intentVector.x*68}px, ${h.intentVector.y*-56}px)`},buildDetail(h){return{kind:"sensor",snapshot:h}},confirm(){return t.confirm()},destroy(){}}}function bt(e,t,n,i){let r=i.value,s=i.value,a=t.getSnapshot().stepEvents.x.sequence;const c=f("Status"),u=f("Committed"),p=f("Draft"),x=f("Intent X");n.metrics.append(c.root,u.root,p.root,x.root);const l=o("div","tte-number-stage"),m=o("p","tte-number-value"),y=o("p","tte-number-copy","Discrete tilt steps update the draft. Commit when it feels right."),v=o("div","tte-track"),h=o("div","tte-track-fill");v.append(h),l.append(m,y,v),n.stage.append(l);const E=T("Reset draft"),q=T("Confirm","primary");n.secondaryActions.append(E,q);const A=b=>{H(n,b),c.value.textContent=R(b.status),u.value.textContent=r.toFixed(0),p.value.textContent=s.toFixed(0),x.value.textContent=b.intentVector.x.toFixed(2),m.textContent=s.toFixed(0),h.style.width=`${(s-i.min)/Math.max(i.max-i.min,1)*100}%`},g=b=>{D(e,"change",{kind:"stepper",snapshot:b,committedValue:r,draftValue:s},i.onChange)},M=b=>{r=s;const B=t.confirm();return A(B),D(e,"commit",{kind:"stepper",snapshot:B,committedValue:r,draftValue:s},i.onCommit),B};return E.addEventListener("click",()=>{s=r,A(t.getSnapshot()),g(t.getSnapshot())}),q.addEventListener("click",()=>{M()}),{update(b){b.stepEvents.x.sequence!==a&&b.stepEvents.x.direction!==0?(a=b.stepEvents.x.sequence,s=L(s+b.stepEvents.x.direction*i.step,i.min,i.max),g(b)):a=b.stepEvents.x.sequence,A(b)},buildDetail(b){return{kind:"stepper",snapshot:b,committedValue:r,draftValue:s}},confirm(){return M()},destroy(){}}}function gt(e,t,n,i){let r=i.value,s=i.value,a=Number.NaN;const c=f("Status"),u=f("Committed"),p=f("Draft"),x=f("Intent X");n.metrics.append(c.root,u.root,p.root,x.root);const l=o("div","tte-number-stage"),m=o("p","tte-number-value"),y=o("p","tte-number-copy","Continuous tilt previews the value before you commit it."),v=o("input","tte-slider");v.type="range",v.readOnly=!0,v.min=String(i.min),v.max=String(i.max),l.append(m,y,v),n.stage.append(l);const h=T("Confirm","primary");n.secondaryActions.append(h);const E=g=>{H(n,g),c.value.textContent=R(g.status),u.value.textContent=r.toFixed(2),p.value.textContent=s.toFixed(2),x.value.textContent=g.intentVector.x.toFixed(2),m.textContent=s.toFixed(2),v.value=String(s)},q=g=>{D(e,"change",{kind:"slider",snapshot:g,committedValue:r,draftValue:s},i.onChange)},A=g=>{r=s;const M=t.confirm();return E(M),D(e,"commit",{kind:"slider",snapshot:M,committedValue:r,draftValue:s},i.onCommit),M};return h.addEventListener("click",()=>{A()}),{update(g){s=L(r+g.intentVector.x*i.sensitivity,i.min,i.max),Math.abs(s-a)>=.01&&(a=s,q(g)),E(g)},buildDetail(g){return{kind:"slider",snapshot:g,committedValue:r,draftValue:s}},confirm(){return A()},destroy(){}}}function ft(e,t,n,i){let r=i.selectedIndex,s=i.selectedIndex,a="idle",c=t.getSnapshot().stepEvents.y.sequence,u=t.getSnapshot().stepEvents.x.sequence;const p=f("Status"),x=f("Selected"),l=f("Highlighted"),m=f("Action"),y=f("Intent");n.metrics.append(p.root,x.root,l.root,m.root,y.root);const v=o("ol","tte-menu-list"),h=i.items.map(d=>{const k=o("li","tte-menu-item"),P=o("span","tte-menu-label",d),z=o("span","tte-menu-state");return k.append(P,z),v.append(k),{row:k,state:z,item:d}});n.stage.append(v);const E=T("Return"),q=T("Commit","primary");n.secondaryActions.append(E,q);const A=()=>{for(const[d,k]of h.entries()){const P=d===s,z=d===r;k.row.dataset.highlighted=String(P),k.row.dataset.selected=String(z),k.state.textContent=z?"Live":P?"Focus":""}},g=d=>{H(n,d),p.value.textContent=R(d.status),x.value.textContent=i.items[r]??"n/a",l.value.textContent=i.items[s]??"n/a",m.value.textContent=a==="idle"?"idle":a==="browse"?"browse":a,y.value.textContent=`${d.intentVector.x.toFixed(2)} / ${d.intentVector.y.toFixed(2)}`,A()},M=d=>{D(e,"change",{kind:"menu",snapshot:d,action:a,selectedIndex:r,highlightedIndex:s,selectedItem:i.items[r]??"",highlightedItem:i.items[s]??""},i.onChange)},b=d=>{r=s,a="committed";const k=t.confirm();g(k);const P={kind:"menu",snapshot:k,action:a,selectedIndex:r,highlightedIndex:s,selectedItem:i.items[r]??"",highlightedItem:i.items[s]??""};return D(e,"commit",P,i.onCommit),k},B=()=>{s=r,a="reverted";const d=t.getSnapshot();return g(d),M(d),d};return E.addEventListener("click",()=>{B()}),q.addEventListener("click",()=>{b()}),{update(d){d.stepEvents.y.sequence!==c&&d.stepEvents.y.direction!==0?(c=d.stepEvents.y.sequence,s=L(s+d.stepEvents.y.direction,0,i.items.length-1),a="browse",M(d)):c=d.stepEvents.y.sequence,d.stepEvents.x.sequence!==u&&d.stepEvents.x.direction!==0?(u=d.stepEvents.x.sequence,Math.abs(d.intentVector.x)>Math.abs(d.intentVector.y)+.08&&(d.stepEvents.x.direction>0?b():B())):u=d.stepEvents.x.sequence,g(d)},buildDetail(d){return{kind:"menu",snapshot:d,action:a,selectedIndex:r,highlightedIndex:s,selectedItem:i.items[r]??"",highlightedItem:i.items[s]??""}},confirm(){return b()},destroy(){}}}function xt(e,t,n,i){switch(i.kind){case"stepper":return bt(e,t,n,i);case"slider":return gt(e,t,n,i);case"menu":return ft(e,t,n,i);default:return ht(e,t,n)}}function G(e,t={}){const n=lt(e),i=N.get(n);if(i)return i;const r=pt(n,t),s=n.shadowRoot??n.attachShadow({mode:"open"}),a=ut(s,r),c=it(mt(r)),u=xt(n,c,a,r),p=m=>{const y=u.buildDetail(m);D(n,"state",y,r.onState)},x=c.subscribe(m=>{u.update(m),p(m)}),l={element:n,kind:r.kind,requestPermission:()=>c.requestPermission(),calibrate:()=>c.calibrate(),pause:()=>c.pause(),resume:()=>c.resume(),confirm:()=>u.confirm(),destroy:()=>{x(),u.destroy(),c.destroy(),s.replaceChildren(),N.delete(n),W.delete(l)},getSnapshot:()=>c.getSnapshot()};return a.requestPermissionButton.addEventListener("click",()=>{l.requestPermission()}),a.calibrateButton.addEventListener("click",()=>{l.calibrate()}),a.pauseButton.addEventListener("click",()=>{if(c.getSnapshot().status==="active"){l.pause();return}l.resume()}),N.set(n,l),W.add(l),u.update(c.getSnapshot()),p(c.getSnapshot()),D(n,"ready",u.buildDetail(c.getSnapshot())),r.autoStart&&c.start(),l}function vt(e){const t=new Set;if(e instanceof HTMLElement&&e.matches(Z)&&t.add(e),"querySelectorAll"in e)for(const n of e.querySelectorAll(Z))t.add(n);return Array.from(t)}function J(e=document,t={}){return vt(e).map(n=>G(n,{backend:t.backend,autoStart:t.autoStart}))}function yt(){return Array.from(W)}const $={version:st,mount:G,scan:J,getInstances:yt};if(typeof window<"u"){window.TiltToEdit=$;const e=()=>{J()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e,{once:!0}):queueMicrotask(e)}return C.TiltToEdit=$,C.default=$,Object.defineProperties(C,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}}),C})({});
